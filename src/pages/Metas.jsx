              ...
              <CardContent className="p-5">
                <div className="flex justify-between items-start mb-3">
                  ...
                  <div className="flex space-x-1">
                    <Button variant="ghost" size="sm" className="h-8 w-8 p-0 text-slate-400 hover:text-vcoral hover:bg-vcoral-50" onClick={() => removerMeta(meta.id)}>
                      <Trash2 size={16} />
                    </Button>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                  ...
                  <Button
                    ...
                    size="sm"
                    className={meta.concluida ? 'text-vblue border-vblue-100 bg-vblue-50 hover:bg-vblue-100' : 'bg-vblue hover:bg-vblue-700 text-white'}
